...
class AddBookSlotExports extends StatefulWidget {
  final bool isExport;
  final VehicleDetailsExports vehicleDetails;
  const AddBookSlotExports({super.key, required this.isExport, required this.vehicleDetails});

  @override
  State<AddBookSlotExports> createState() => _AddBookSlotExportsState();
}
class _AddBookSlotExportsState extends State<AddBookSlotExports> {
  final _formKey = GlobalKey<FormState>();
  String slotFilterDate = "Slot Date";
  DateTime? selectedDate;
  final AuthService authService = AuthService();
